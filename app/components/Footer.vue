...
<template>
  <footer class="transition-all duration-500" style="border-top: 1px solid var(--border); background-color: var(--bg-secondary);">
      ...
      <div class="flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-4">
          <a
            ...
            class="p-2 transition-all duration-300 hover:scale-110"
