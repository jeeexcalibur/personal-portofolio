...
<template>
  <section id="education" ref="beatRef" class="story-beat transition-all duration-500" style="background-color: var(--bg-primary);">
        ...
        <div class="mt-8 relative">
          ...
          <div class="space-y-6">
            <div 
              ...
              :key="edu.institution"
              class="relative pl-0 sm:pl-16 scroll-reveal"
            ...
            >
              ...
              <!-- Card -->
              <div class="card card-enhanced overflow-hidden group hover:translate-x-1 transition-all duration-300">
                <!-- Accent top bar -->
                ...
                <div class="p-5 sm:p-6">
                  ...
                  <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-3">
                    <div class="flex items-start gap-4">
                      ...
                      <div>
                        <h3 class="text-lg sm:text-xl font-bold transition-colors" style="color: var(--text-primary);">
                          {{ edu.institution }}
                        </h3>
